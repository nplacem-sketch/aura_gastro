    ...
    <div className="mx-auto max-w-7xl pb-12">
      <header className="mb-12 flex flex-col items-end justify-between gap-6 md:flex-row">
        <div>
          <Link
            href="/recipes"
            className="mb-3 flex items-center gap-2 font-label text-[10px] uppercase tracking-widest text-secondary/60 transition-colors hover:text-secondary"
          >
            <AppIcon name="arrow_upward" size={12} className="-rotate-90" />
            Manual de Protocolo
          </Link>
        ...
        <button
          type="button"
          className="glass-panel group flex items-center gap-2 rounded-lg border border-secondary/20 px-6 py-3 font-label text-[10px] uppercase tracking-widest text-secondary transition-all hover:bg-secondary/10"
        >
          Nueva creacion
                  ...
                  <div className="relative z-10 flex h-full flex-col">
                    ...
                    {!canAccess && (
                      <LockedContentOverlay
                        ...
                        description="Esta elaboracion pertenece a un plan superior."
                      />
                    )}
