...
const supplementalIngredients = [
  { name: 'Cloruro calcico', scientific_name: 'Calcium chloride', category: 'TEXTURIZANTE', tier: 'PRO', origin_region: 'Mineral purificado', best_season: ['Todo el ano'], culinary_notes: 'Fuente de calcio muy reactiva para banos tecnicos de esferificacion basica.', technical_data: { 'Dosificacion orientativa': '5-8 g/L', Aplicacion: 'Banos calcicos', Observacion: 'Sabor amargo si no se lava bien', 'Uso clave': 'Gelificacion rapida' } },
  { name: 'Gluconolactato calcico', scientific_name: 'Calcium lactate gluconate', category: 'TEXTURIZANTE', tier: 'PREMIUM', origin_region: 'Sales de calcio grado alimentario', best_season: ['Todo el ano'], culinary_notes: 'Aporta calcio con perfil sensorial mas limpio para esferificacion inversa.', technical_data: { 'Dosificacion orientativa': '20-40 g/L', Aplicacion: 'Esferificacion inversa', Observacion: 'Disolucion completa antes del reposo', 'Uso clave': 'Centro fluido estable' } },
  { name: 'Goma guar', scientific_name: 'Cyamopsis tetragonoloba gum', category: 'ESTABILIZANTE', tier: 'PRO', origin_region: 'Semilla de guar', best_season: ['Todo el ano'], culinary_notes: 'Espesante en frio de hidratacion rapida, util para salsas y masas fluidas.', technical_data: { 'Dosificacion orientativa': '1-5 g/L', Aplicacion: 'Salsas y cremas', Solubilidad: 'Alta en frio', 'Uso clave': 'Aumento de viscosidad' } },
  { name: 'Gellan', scientific_name: 'Gellan gum', category: 'TEXTURIZANTE', tier: 'PREMIUM', origin_region: 'Fermentacion bacteriana', best_season: ['Todo el ano'], culinary_notes: 'Permite geles limpios, transparentes y de gran precision de corte.', technical_data: { 'Dosificacion orientativa': '2-10 g/L', Aplicacion: 'Geles firmes y fluid gels', Activacion: 'Calor', 'Uso clave': 'Gelificacion precisa' } },
  { name: 'Kappa carragenato', scientific_name: 'Carrageenan kappa', category: 'TEXTURIZANTE', tier: 'PREMIUM', origin_region: 'Algas rojas', best_season: ['Todo el ano'], culinary_notes: 'Produce geles firmes, especialmente utiles en lacteos y bases con potasio.', technical_data: { 'Dosificacion orientativa': '3-8 g/L', Aplicacion: 'Geles lacteos', Textura: 'Firme', 'Uso clave': 'Corte limpio' } },
  { name: 'Pectina NH', scientific_name: 'Thermoreversible low methoxyl pectin', category: 'TEXTURIZANTE', tier: 'PRO', origin_region: 'Fruta citrica y manzana', best_season: ['Todo el ano'], culinary_notes: 'Pectina pensada para glaseados y geles termorreversibles de fruta.', technical_data: { 'Dosificacion orientativa': '8-20 g/Kg', Aplicacion: 'Frutas y glaseados', Activacion: 'Azucar y acido', 'Uso clave': 'Brillos y rellenos' } },
  { name: 'Pectina amarilla', scientific_name: 'High methoxyl pectin', category: 'TEXTURIZANTE', tier: 'PRO', origin_region: 'Fruta citrica y manzana', best_season: ['Todo el ano'], culinary_notes: 'Indicada para pastas de fruta y geles dulces de alto solido soluble.', technical_data: { 'Dosificacion orientativa': '10-18 g/Kg', Aplicacion: 'Pates de fruits', Activacion: 'Azucar alta y acidez', 'Uso clave': 'Gel dulce estructurado' } },
  { name: 'Maltodextrina tapioca', scientific_name: 'Tapioca maltodextrin', category: 'TEXTURIZANTE', tier: 'PREMIUM', origin_region: 'Tapioca procesada', best_season: ['Todo el ano'], culinary_notes: 'Transforma grasas en polvos ligeros y secos para acabados de alta cocina.', technical_data: { 'Dosificacion orientativa': 'Segun absorcion', Aplicacion: 'Polvos grasos', Solubilidad: 'Alta', 'Uso clave': 'Texturas secas' } },
  { name: 'Transglutaminasa', scientific_name: 'Transglutaminase enzyme', category: 'TEXTURIZANTE', tier: 'PREMIUM', origin_region: 'Fermentacion controlada', best_season: ['Todo el ano'], culinary_notes: 'Enzima de union proteica para piezas recompuestas y laminados tecnicos.', technical_data: { 'Dosificacion orientativa': '0.5-1%', Aplicacion: 'Union proteica', Observacion: 'Trabajo en frio y reposo', 'Uso clave': 'Reestructuracion' } },
  { name: 'Isomalt', scientific_name: 'Isomaltulose derivative', category: 'SABORIZANTE', tier: 'PRO', origin_region: 'Azucar remolacha', best_season: ['Todo el ano'], culinary_notes: 'Azucar tecnico util para piezas de azucar con menor higroscopicidad.', technical_data: { 'Dosificacion orientativa': 'Segun pieza', Aplicacion: 'Azucar artistico', Observacion: 'Fundir con control', 'Uso clave': 'Decoracion estable' } },
  { name: 'Acido citrico', scientific_name: 'Citric acid', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Fermentacion y citricos', best_season: ['Todo el ano'], culinary_notes: 'Acidulante de referencia para ajustar pH en elaboraciones dulces y saladas.', technical_data: { 'Dosificacion orientativa': '0.5-3 g/L', Aplicacion: 'Ajuste de pH', Observacion: 'Anadir poco a poco', 'Uso clave': 'Correccion acida' } },
  { name: 'Acido ascorbico', scientific_name: 'Ascorbic acid', category: 'SABORIZANTE', tier: 'PRO', origin_region: 'Vitamina C purificada', best_season: ['Todo el ano'], culinary_notes: 'Antioxidante para preservar color y frescura en frutas y vegetales.', technical_data: { 'Dosificacion orientativa': '0.5-2 g/L', Aplicacion: 'Antioxidacion', Observacion: 'Uso moderado', 'Uso clave': 'Proteccion de color' } },
  { name: 'Sal fina', scientific_name: 'Sodium chloride', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Minas y salinas', best_season: ['Todo el ano'], culinary_notes: 'Condimento base para sazonar y equilibrar formulaciones.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Sazonado', Observacion: 'Disolver bien', 'Uso clave': 'Equilibrio de sabor' } },
  { name: 'Azucar', scientific_name: 'Sucrose', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Remolacha o cana', best_season: ['Todo el ano'], culinary_notes: 'Base dulce para jarabes, glaseados, geles y fermentaciones controladas.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Dulzor y estructura', Observacion: 'Control de brix', 'Uso clave': 'Dulzor' } },
  { name: 'Glucosa', scientific_name: 'Glucose syrup', category: 'SABORIZANTE', tier: 'PRO', origin_region: 'Almidon hidrolizado', best_season: ['Todo el ano'], culinary_notes: 'Aporta cuerpo y controla cristalizacion en postreria y salsas dulces.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Jarabes y heladeria', Observacion: 'Aporta elasticidad', 'Uso clave': 'Control de cristalizacion' } },
  { name: 'Aceite de oliva virgen extra', scientific_name: 'Olea europaea oil', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Mediterraneo', best_season: ['Todo el ano'], culinary_notes: 'Grasa noble para aliños, emulsiones y acabados aromaticos.', technical_data: { 'Dosificacion orientativa': 'Segun plato', Aplicacion: 'Aliños y acabados', Observacion: 'Elegir perfil adecuado', 'Uso clave': 'Aroma graso' } },
  { name: 'Vinagre de jerez', scientific_name: 'Sherry vinegar', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Jerez de la Frontera', best_season: ['Todo el ano'], culinary_notes: 'Vinagre de acidez redonda muy util para vinagretas, reducciones y escabeches.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Acidez y fondo', Observacion: 'Integrar con grasa', 'Uso clave': 'Equilibrio acido' } },
  { name: 'Nata', scientific_name: 'Cream', category: 'EMULSIFICANTE', tier: 'FREE', origin_region: 'Lacteo', best_season: ['Todo el ano'], culinary_notes: 'Aporta grasa, redondez y soporte para espumas y salsas.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Salsas y espumas', Observacion: 'Controlar reduccion', 'Uso clave': 'Redondez' } },
  { name: 'Mantequilla', scientific_name: 'Butter', category: 'EMULSIFICANTE', tier: 'FREE', origin_region: 'Lacteo', best_season: ['Todo el ano'], culinary_notes: 'Grasa de acabado y montado, clave para brillo y untuosidad.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Montar salsas', Observacion: 'Anadir fuera de hervor', 'Uso clave': 'Brillo' } },
  { name: 'Patata', scientific_name: 'Solanum tuberosum', category: 'SABORIZANTE', tier: 'FREE', origin_region: 'Tuberculo', best_season: ['Todo el ano'], culinary_notes: 'Base versatil para cremas, purees, guarniciones y espesados suaves.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Purees y fondos', Observacion: 'Evitar sobretrabajo', 'Uso clave': 'Textura suave' } },
  { name: 'Huevos', scientific_name: 'Gallus gallus domesticus', category: 'EMULSIFICANTE', tier: 'FREE', origin_region: 'Avicola', best_season: ['Todo el ano'], culinary_notes: 'Ingrediente estructural y emulsionante esencial en cocina y pasteleria.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Ligazon y estructura', Observacion: 'Control termico critico', 'Uso clave': 'Coagulacion' } },
  ...
  { name: 'Jugo de aceituna verde', scientific_name: 'Green olive liquor', category: 'SABORIZANTE', tier: 'PREMIUM', origin_region: 'Aceituna procesada', best_season: ['Todo el ano'], culinary_notes: 'Base intensa y salina para esferas y salsas de estilo mediterraneo.', technical_data: { 'Dosificacion orientativa': 'Segun receta', Aplicacion: 'Esferificacion', Observacion: 'Controlar salinidad', 'Uso clave': 'Perfil salino' } },
];
